...
# any one can add product to cart, no need of signin
def add_to_cart_custome(request,pk):
    products=models.Product.objects.all()
    ...
    response = render(request, 'ecom/index2.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def customize(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request,'ecom/customer_home2.html',{'products':products,'product_count_in_cart':product_count_in_cart})
